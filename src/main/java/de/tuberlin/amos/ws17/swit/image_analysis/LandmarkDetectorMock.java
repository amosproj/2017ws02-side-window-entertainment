...
public class LandmarkDetectorMock implements LandmarkDetector {
    ...
    public static LandmarkDetector getInstance() {
        if (instance == null) {
            LandmarkDetectorMock landmarkDetectorMock = new LandmarkDetectorMock();
            ...
            landmarkDetectorMock.pois.add(brandenburgerGate);
            landmarkDetectorMock.pois.add(fernsehturm);
            landmarkDetectorMock.pois.add(worldClock);
            landmarkDetectorMock.pois.add(berlinCathedral);
            instance = landmarkDetectorMock;
        }
        return instance;
    }
