...
public class NoLabelRingProgressViewSkin implements Skin<RingProgressIndicator> {
    ...
    public NoLabelRingProgressViewSkin(final RingProgressIndicator indicator) {
